...
from kin_txt_core.types.reports import RawContentTypes, VisualizationDiagramTypes
from kin_txt_core.reports_building.domain.entities import StatisticalReport
