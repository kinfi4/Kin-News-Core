...
class WordCloudReportBuilder:
    ...
    def set_data_by_channel_by_category(self, data: dict[str, dict[str, list[tuple[str, int]]]]) -> Self:
    ...
    def set_data_by_category(self, data: dict[str, list[tuple[str, int]]]) -> Self:
